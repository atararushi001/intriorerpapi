...
const createDesignApproval = async (req, res) => {
  try {
    ...
    res.status(500).json({ message: "Error creating design approval", error });
  }
};
...
const getDesignApprovals = async (req, res) => {
  try {
    ...
    res.status(500).json({ message: "Error fetching design approvals", error });
  }
};
...
const getDesignApprovalById = async (req, res) => {
  try {
    ...
    res.status(500).json({ message: "Error fetching design approval", error });
  }
};
...
const updateDesignApproval = async (req, res) => {
  try {
    ...
    res.status(500).json({ message: "Error updating design approval", error });
  }
};
...
const deleteDesignApproval = async (req, res) => {
  try {
    ...
    res.status(200).json({ message: "Design approval deleted successfully" });
  } catch (error) {
    res.status(500).json({ message: "Error deleting design approval", error });
  }
};
